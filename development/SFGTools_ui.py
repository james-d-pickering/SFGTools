...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.calibrate_offset_box.setText("")
        self.calibrate_offset_box.setObjectName("calibrate_offset_box")
        self.gridLayout_2.addWidget(self.calibrate_offset_box, 4, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.subtract_checkbox, 1, 0, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.exposure_checkbox, 3, 0, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.downconvert_checkbox, 0, 0, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.normalise_checkbox, 2, 0, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.killcosmic_checkbox, 4, 0, 1, 3)
        self.calibrate_button = QtWidgets.QPushButton(self.layoutWidget1)
        self.calibrate_button.setEnabled(False)
        self.calibrate_button.setObjectName("calibrate_button")
        self.gridLayout_4.addWidget(self.calibrate_button, 8, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.calibrate_checkbox, 7, 0, 1, 1)
        self.calibration_degree_box = QtWidgets.QLineEdit(self.layoutWidget1)
        self.calibration_degree_box.setEnabled(False)
        self.calibration_degree_box.setObjectName("calibration_degree_box")
        self.gridLayout_4.addWidget(self.calibration_degree_box, 7, 2, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.cosmic_threshold_box, 5, 1, 1, 2)
        self.calibration_sample_dropdown = QtWidgets.QComboBox(self.layoutWidget1)
        self.calibration_sample_dropdown.setEnabled(False)
        self.calibration_sample_dropdown.setObjectName("calibration_sample_dropdown")
        self.calibration_sample_dropdown.addItem("")
        self.calibration_sample_dropdown.addItem("")
        self.calibration_sample_dropdown.addItem("")
        self.gridLayout_4.addWidget(self.calibration_sample_dropdown, 8, 1, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.cosmic_width_box, 6, 1, 1, 2)
        ...
        self.calibration_sample_dropdown.setCurrentIndex(0)
        ...
        self.calibrate_checkbox.clicked['bool'].connect(self.calibrate_button.setEnabled)
        self.calibrate_checkbox.clicked['bool'].connect(self.calibration_sample_dropdown.setEnabled)
        self.calibrate_button.clicked.connect(MainWindow.calibrate_buttonSlot)
        self.calibration_sample_dropdown.currentTextChanged['QString'].connect(MainWindow.calibration_sample_dropdownSlot)
        self.calibrate_checkbox.clicked['bool'].connect(self.calibration_degree_box.setEnabled)
        self.calibration_degree_box.editingFinished.connect(MainWindow.calibration_degree_boxSlot)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.calibrate_offset_label.setText(_translate("MainWindow", "Calibration Coefficients"))
        self.label.setText(_translate("MainWindow", "nm"))
        self.calibrate_offset_box.setToolTip(_translate("MainWindow", "Calibration coefficients to correct the energy axis."))
        self.calibrate_offset_box.setStatusTip(_translate("MainWindow", "Calibration coefficients to correct the energy axis."))
        self.calibrate_offset_box.setWhatsThis(_translate("MainWindow", "Calibration coefficients to correct the energy axis. For a linear shift of +number, simply enter (number)."))
        self.calibrate_offset_box.setPlaceholderText(_translate("MainWindow", "(n, (n-1), ... , (offset))"))
        ...
        self.calibrate_button.setText(_translate("MainWindow", "Open Calibrator..."))
        ...
        self.calibration_degree_box.setText(_translate("MainWindow", "1"))
        self.calibration_degree_box.setPlaceholderText(_translate("MainWindow", "Calibration Degree"))
        ...
        self.calibration_sample_dropdown.setItemText(0, _translate("MainWindow", "Polystyrene"))
        self.calibration_sample_dropdown.setItemText(1, _translate("MainWindow", "Water"))
        self.calibration_sample_dropdown.setItemText(2, _translate("MainWindow", "CO2"))
        ...
        self.title_label.setText(_translate("MainWindow", "SFGTools GUI - v1.0.1"))
